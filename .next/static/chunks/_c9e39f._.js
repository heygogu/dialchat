(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_c9e39f._.js", {
...
"[project]/components/providers/Provider.tsx [app-client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";
...
function GlobalProvider({ children, userInfo: initialUserInfo }) {
    ...
    const [userInfo, setUserInfo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialUserInfo || null);
    console.log(initialUserInfo, "initialUserInfo");
    if (userInfo?.access_token) {
        __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$henceforthApi$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].setToken(userInfo.access_token);
    }
    ...
    const logout = async ()=>{
        ...
        setUserInfo(null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nookies$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["destroyCookie"])(null, "COOKIES_ADMIN_ACCESS_TOKEN", {
            path: "/"
        });
        router.replace("/");
    };
    const getProfile = async ()=>{
        try {
            const apiRes = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$henceforthApi$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].SuperAdmin.profile();
...
_s(GlobalProvider, "Cgae+c1iIK1Pk9tv8EjQuivTs8E=", false, function() {
    return [
...
//# sourceMappingURL=_c9e39f._.js.map